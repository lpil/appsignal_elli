# Lifted from the Appsignal test suite
...
defmodule TestAgent do
  defmacro __using__(default_state) do
    quote do
      ...
      # Function not originally in the Appsignal version
      def reset(pid_or_module) do
        Agent.update(pid_or_module, fn _ -> unquote(default_state) end)
      end
